...
try {
    ...
    if($row) {
        ...
        // 年月日を分割
        $selected = explode("-", $row['view_date']);
...
<div class="review-container">
    ...
    <form action="review/review_update.php?review_id=<?= $row['review_id'] ?>&product_id=<?= $row['product_id'] ?>" method="POST"> 
                    ...
                    <div class="input-group score-group">
                        ...
                        <select id="score" name="score">
                            <?php for ($i = 5.0; $i >= 0.5; $i -= 0.5): ?>
                                <option value="<?= $i ?>" <?= ($score == $i) ? 'selected' : '' ?>>
                                    <?= number_format($i, 1) ?>
                                </option>
                            <?php endfor; ?>
                        </select>
                        ...
                        <div class="date-selects">
                            ...
                            <select name="year" required>
                                ...
                                <?php foreach ($years as $year): ?>
                                    <option value="<?php echo $year; ?>" <?= $selected[0] == $year ? "selected" : "" ?>>
                                        <?php echo $year; ?>
                                    </option>
                                <?php endforeach; ?>
                            </select>
                            ...
                            <select name="month" required>
                                ...
                                <?php foreach ($months as $month): ?>
                                    <option value="<?php echo $month; ?>" <?= $selected[1] == $month ? "selected" : "" ?>>
                                        <?php echo $month; ?>
                                    </option>
                                <?php endforeach; ?>
                            </select>
                            ...
                            <select name="day" required>
                                ...
                                <?php foreach ($days as $day): ?>
                                    <option value="<?php echo $day; ?>" <?= $selected[2] == $day ? "selected" : "" ?>>
                                        <?php echo $day; ?>
                                    </option>
                                <?php endforeach; ?>
                            </select>
